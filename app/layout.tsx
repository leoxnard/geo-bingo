...
export const metadata: Metadata = {
  title: "Geo Bingo",
  description:
    "Challenge your friends to a game of Geo Bingo! Explore the world around you and mark off items on your bingo card as you find them in real life. Who will be the first to get a bingo?",
  icons: {
