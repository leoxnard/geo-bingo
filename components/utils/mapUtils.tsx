...
export const mapOptions = (
  additionalOptions: { [key: string]: unknown | google.maps.MapOptions } = {},
...
export const insertPoint = (
  ...
  const doIntersect = (p1: Point, q1: Point, p2: Point, q2: Point) => {
    ...
    if (isSame(p1, p2) || isSame(p1, q2) || isSame(q1, p2) || isSame(q1, q2))
      return false;
...
export function isLocationAllowed(
  ...
  try {
    ...
    const hasAllowZones = parsed.some(
      (b) => b.type === "allow" && b.points.length >= 3,
    );
    if (hasAllowZones) {
      return false;
    }
