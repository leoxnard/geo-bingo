    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-slate-900 text-white">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
                ...
                <h1 className="text-6xl font-bold text-indigo-400 tracking-tighter hidden sm:block">PREVIEW LOGIN</h1>
            </div>
            ...
            <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700 w-full max-w-md flex flex-col gap-4">
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    {error && <p className="text-red-500 text-xs font-medium text-center">Login-Daten falsch!</p>}
