export const getPromptForNearbyPlaceCategories = (cityCountry: string, uniquePlacesForLLM: { id: string; name: string }[], requiredCount: number, difficulty: 'default' | 'easy' | 'hard', language: string): string => {
    if (difficulty === 'easy') {
