    ...
    try {
        ...
        const typeGroups = [
            ...
            },
            {
                ...
                types: ['library', 'museum', 'art_gallery', 'church', 'sculpture', 'performing_arts_theater', 'university', 'historical_place'],
            },
            {
                // 5. Extremely Rare & Unique Landmarks
                name: 'grand_and_specialized',
                types: ['city_hall', 'courthouse', 'embassy', 'castle', 'stadium', 'airport', 'ferry_terminal', 'fire_station', 'zoo', 'botanical_garden', 'beach', 'historical_landmark', 'tourist_attraction', 'synagogue', 'mosque', 'shinto_shrine', 'buddhist_temple', 'casino', 'amphitheatre'],
            },
        ];
